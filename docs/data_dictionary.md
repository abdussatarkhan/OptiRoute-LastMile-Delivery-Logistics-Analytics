...
## 🏢 Platform: OptiRoute: Urban Last-Mile Courier Fleet & Route Density Analytics
**Schema**: `optiroute_dw`  
...
### 2. `dim_drivers_courier`
Dimensional attribute master for Drivers Courier.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `drivers_courier_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `drivers_courier_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
...
### 2. `dim_delivery_zones`
Dimensional attribute master for Delivery Zones.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `delivery_zones_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `delivery_zones_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### 2. `dim_depot_hubs`
Dimensional attribute master for Depot Hubs.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `depot_hubs_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `depot_hubs_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### 2. `dim_vehicle_types`
Dimensional attribute master for Vehicle Types.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `vehicle_types_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `vehicle_types_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### `fact_parcel_dropoffs`
Transactional and snapshot grain telemetry table tracking Parcel Dropoffs.
...
### `fact_route_execution_telemetry`
Transactional and snapshot grain telemetry table tracking Route Execution Telemetry.
...
### `fact_failed_attempts`
Transactional and snapshot grain telemetry table tracking Failed Attempts.
...
Transactional and snapshot grain telemetry table tracking Fuel Consumption.
